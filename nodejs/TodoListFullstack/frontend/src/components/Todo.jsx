...
function Todo() {
	...
	const backendUrl = process.env.VITE_BACKEND_URL || 'http://127.0.0.1:5000';
        ...
        axios.get(`${backendUrl}/getTodoList`)
            .then(result => {
	...
	const backendUrl = process.env.VITE_BACKEND_URL || 'http://127.0.0.1:5000';
        ...
        axios.post(`${backendUrl}/addTodoList`, { task: newTask, status: newStatus, deadline: newDeadline })
            .then(res => {
                console.log(res);
	...
	const backendUrl = process.env.VITE_BACKEND_URL || 'http://127.0.0.1:5000';
        ...
        axios.post(`${backendUrl}/updateTodoList/` + id, editedData)
            .then(result => {
                console.log(result);
                setEditableId(null);
                setEditedTask("");
	...
	const backendUrl = process.env.VITE_BACKEND_URL || 'http://127.0.0.1:5000';
        ...
        axios.delete(`${backendUrl}/deleteTodoList/` + id)
            .then(result => {
                console.log(result);
                window.location.reload();
            })
